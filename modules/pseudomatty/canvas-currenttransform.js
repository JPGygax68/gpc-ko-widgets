 ...
 * Please remove the yellow, tasty fruit from my email address in order to
 * contact me.
 *
 * I, the author of this code, grant any entity the right to use this code for
 ...
 * nor of its fitness for any particular purpose, nor of anything else whatsoever.
 * 
 * Patches, bugfixes, enhancements, use stories etc are welcome - please email me.
 */
(function() {
  console.log('canvas-currenttransform here!');
